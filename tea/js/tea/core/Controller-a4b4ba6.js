/**
 * Created by seanxphuang on 15-4-18.
 */
define('core/Controller', function(require, exports, module) {
    ...
    module.exports = Class.extend(methods, Attributes, {
        ...
        /*
         * 恢复事件监听
         * 当调用了this.off()移除了事件监听时，可以使用这个方法恢复监听事件
         * 仅对this.events/this.get('events')里监听的事件
         */
        detect: function(){
        	this._initEvents();
        },

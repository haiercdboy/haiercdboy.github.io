 ...
 */
define('util/Promise', function(require, exports, module){
     ...
     *          })
     */
    var Promise = module.exports = exports = Class.extend({
        ...
        promise: function( obj ) {
            ...
            $.each(['state', 'always', 'then', 'promise', 'done', 'fail', 'progress', 'isResolved', 'isRejected'], function( i, method ){
                promiseObj[method] = function(){

define('biz/monitor/logger/tryJs', function(require, exports, module){
	var BJ_REPORT = require('biz/monitor/logger/report');
	...
	(function (root) {
	    ...
	    var tryJs = BJ_REPORT.tryJs = function init(throwCb) {
	    ...
	    for(var name in tryJs) {
			if(tryJs.hasOwnProperty(name)) {
				BJ_REPORT[name] = tryJs[name];
			}
		}
